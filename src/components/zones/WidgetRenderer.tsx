 ...
 * elements; pulling in a motion runtime for that would cost more than it
 * animates. Every variant is defined under a `motion-safe:` prefix, so
 * `prefers-reduced-motion` disables them without a second code path — motion is
 * a flourish, and for some people it is a symptom.
 */

...
/**
 * Ο σκελετός κάθε σελίδας λίστας προϊόντων.
 *
 * Αναπαράγει ακριβώς τη δομή της πραγματικής: σκούρα κεφαλίδα με σειρά chips,
 * μπάρα εργαλείων 74px, πλαϊνή στήλη 326px και πλέγμα τεσσάρων — ώστε το
 * περιεχόμενο που φτάνει να μη μετακινήσει τίποτα. Ένας κατά προσέγγιση
 * σκελετός αναδιατάσσει τη σελίδα δύο φορές αντί για μία, που διαβάζεται
 * χειρότερα από καθόλου σκελετό.
 *
 * Κοινός για /katalogos/[κατηγορία] και /proionta: η ίδια διάταξη σε δύο
 * διαδρομές είχε σκελετό μόνο η μία — η άλλη έπαιρνε της αρχικής.
 */
